...
HD_PWD='C:/Users/zacht/Documents/- School/COEN 4710 - Computer Hardware/Projects/Project 2/project_2c/project_2c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_main.tcl
